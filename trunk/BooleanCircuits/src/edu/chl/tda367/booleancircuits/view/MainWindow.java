...
public class MainWindow extends javax.swing.JFrame implements
	...
	private void initButtons() {
		...
		toolbar.getToolbarPanel().getCutButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getCopyButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getNewWorkspaceButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getOpenFileButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getPasteButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getRedoButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getSaveAsComponentButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getSaveAllButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getSaveButton().addActionListener(actionController);
		toolbar.getToolbarPanel().getUndoButton().addActionListener(actionController);
	}
